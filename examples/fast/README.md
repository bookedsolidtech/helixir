# HELiXiR + FAST (Fluent UI Web Components)

This example configures HELiXiR to work with [FAST Fluent UI](https://www.fast.design/) — Microsoft's web component implementation of the Fluent design system, built on the FAST foundation.
...
## Example: Claude Using HELiXiR with FAST Fluent UI
